		...
		<div>
		  ...
		  <div class="tab-content" style="margin-top:30px;border:1px solid #dddddd;padding:10px 2%;">
		    <div role="tabpanel" class="tab-pane active" id="home">
				...
				<div class="col-sm-6"><span>订单状态：</span><?php if($order["type"] == 0 ): ?><font color="red" size="4">待发货</font><?php endif; ?>
				...
				<div class="col-sm-6"><span>通讯地址：</span><?php echo ($user_address['city']); echo ($user_address['address']); ?></div>
				<div style="clear:both;"></div>
				...
				<table class="table table-striped" style="font-size:14px;">
					...
					<?php if(is_array($order_info)): $i = 0; $__LIST__ = $order_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>￥<?php echo ($v["good_danjia"]); ?></td>
						<td><?php echo ($v["good_num"]); ?></td>
						<td>￥<?php echo ($v["good_price"]); ?></td>
						<td><?php echo ($v["type"]); ?></td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					<tr><td style="color:red">订单总金额 ￥<?php echo ($order["zonge"]); ?>
						&nbsp;&nbsp;&nbsp;
				...
				<div class="form-horizontal" style="height: 400px">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							<?php if($order["order_sn"] == 0): ?><input type="text"  class="form-control" value="" name="order_sn" id="order_sn" />
							<?php else: ?>
							<input type="text"  class="form-control" value="<?php echo ($order["order_sn"]); ?>" name="order_sn" id="order_sn" /><?php endif; ?>
...
<script>
  ...
  $(this).tab('show')
	...
	function goLastPage(p){
		location.href = "<?php echo U('order');?>?p=" + p;
	}
